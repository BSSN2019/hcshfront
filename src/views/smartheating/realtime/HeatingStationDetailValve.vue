                ...
                <table>
                  <tr>
                    ...
                    <td colspan="2" align="right">
                      <a-radio-group v-model="controlValue.EQCBW005" button-style="solid" @change="EQCBW005Change">
                  ...
                  <tr>
                    ...
                    <td width="16%">
                      <a-input-number
                        ...
                        :disabled="settingStyle.disabledValue.TETFW006">
                      </a-input-number>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <a-input-number
                        ...
                        :disabled="settingStyle.disabledValue.TETFW008">
                      </a-input-number>
                    </td>
                    <td class="leftTitle">℃</td>
                  </tr>
