              ...
              <div>
                <table>
                  ...
                  <tr>
                    ...
                    <td ><a-input-number v-model="settingValue.WLTFW002" class="textField" style="width:30%"></a-input-number></td>
                    <td>m</td>
                  </tr>
                    <td width="50%"></td>
                  </tr>
                  ...
                  <tr>
                    <td class="leftTitle">水箱液位低限设定</td>
                    <td ><a-input-number v-model="settingValue.WLTFW003" class="textField" style="width:30%"></a-input-number></td>
                    <td>m</td>
                  </tr>
                  </tr>
