      ...
      <div style="width:100%;height:800px">
        ...
        <a-row>
          ...
          <a-col span="16">
            ...
            <div class="WQMFR002">{{ monitoringValue.WQMFR002 }}</div>
            <div class="WLMFR001">{{ monitoringValue.WLMFR001 }}</div>
            <div class="EQSBR015">
              <img v-if="statusValue.EQSBR015 === 1" src="~@/assets/realtime/pumprun.png" alt="logo" style="width:43px; height:43px ">
              <img v-if="statusValue.EQSBR015 === 0" src="~@/assets/realtime/pumpstop.png" alt="logo" style="width:43px; height:43px ">
              <img v-if="statusValue.EQSBR015 === 99" src="~@/assets/realtime/pumpalarm.png" alt="logo" style="width:43px; height:43px ">
              <img v-if="statusValue.EQSBR015 === 100" src="~@/assets/realtime/pumpinterrupt.png" alt="logo" style="width:43px; height:43px ">
            </div>
          </a-col>
          <a-col span="1"></a-col>
        </a-row>
