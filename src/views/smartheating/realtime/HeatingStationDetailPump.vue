                ...
                <table>
                  <tr>
                    ...
                    <td colspan="2" align="right">
                      <a-radio-group v-model="controlValue.EQCBW010" button-style="solid" @change="EQCBW010Change">
                  ...
                  <tr>
                    ...
                    <td>
                      <a-input-number v-model="settingValue.TETFW009" style="width:100%" :class="settingStyle.textClass.TETFW009" :disabled="settingStyle.disabledValue.TETFW009"></a-input-number>
                    </td>
                  ...
                  <tr>
                    ...
                    <td width="16%">
                      <a-input-number
                        ...
                        :disabled="settingStyle.disabledValue.TETFW010">
                      </a-input-number>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <a-input-number
                        ...
                        :disabled="settingStyle.disabledValue.TETFW012">
                      </a-input-number>
                    </td>
                    <td class="leftTitle">℃</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a-input-number v-model="settingValue.FQTFW004" class="textField" style="width:100%" :class="settingStyle.textClass.FQTFW004" :disabled="settingStyle.disabledValue.FQTFW004"></a-input-number>
                    </td>
...
export default {
    ...
    data () {
        return {
            ...
            controlValue: {
                EQCBW010: '', // 电调阀PLC手动/自动开关
                EQCBW012: '', // 电调阀页面自动算法A开关
                EQCBW011: '', // 电调阀页面自动算法B开关
                EQCBW014: '', // 电调阀页面自动算法C开关
            ...
            settingValue: {
                TETFW009: '', // 电调阀PLC自动二出温度设定
                TETFW010: '', // 电调阀页面算法A温度设定
                TETFW007: '', // 电调阀页面算法B温度设定
                TETFW012: '', // 电调阀页面算法C温度设定
                TETFW011: '', // 二级泵页面算法B温度设定
                FQTFW004: '', // 一次电调阀手工开度设定
    ...
    methods: {
        ...
        handleChangeA () {
            /** 算法A - 上线 */
            if (this.controlValue.EQCBW012 === '1') {
                /** 二级泵PLC自动二出温度设定无效 */
                this.settingStyle.textClass.TETFW009 = 'disableText'
                this.settingStyle.disabledValue.TETFW009 = true
                /** 算法A - 上线 */
        ...
        handleChangeB () {
            /** 算法B - 上线 */
            if (this.controlValue.EQCBW013 === '1') {
                /** 二级泵PLC自动二出温度设定无效 */
                this.settingStyle.textClass.TETFW009 = 'disableText'
                this.settingStyle.disabledValue.TETFW009 = true
                /** 算法A-下线 */
        ...
        handleChangeC () {
            /** 算法C - 上线 */
            if (this.controlValue.EQCBW014 === '1') {
                /** 二级泵PLC自动二出温度设定无效 */
                this.settingStyle.textClass.TETFW009 = 'disableText'
                this.settingStyle.disabledValue.TETFW009 = true
                /** 算法A - 下线 */
        ...
        displayControlButtons () {
            ...
            /** 如果电调阀控制为自动 */
                ...
                if (this.controlValue.EQCBW011 === '1') {
                    /** 算法A按钮有效，设定值无效 */
                    this.controlValue.EQCBW012 = '0'
                    this.settingStyle.disabledValue.EQCBW012 = false
                    this.settingStyle.textClass.TETFW010 = 'disableText'
