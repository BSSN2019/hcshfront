...
export default {
    name: 'HeatingSourceParameterModal',
    components: {},
    data () {
        return {
            ...
            url: {
                ...
                addableParameters: '/basicdata/heatingsource/addableparameters',
    ...
    methods: {
        ...
        edit (record) {
            ...
            if (this.model.id) {
                ...
                this.heatingSourceId = this.model.heatingsource
        ...
        loadParameterList () {
            getAction(this.url.addableParameters, { id: this.heatingSourceId }).then(res => {
                if (res.success) {
                    this.parameterList = []
