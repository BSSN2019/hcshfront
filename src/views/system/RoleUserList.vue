<template>
  <a-card :bordered="false" title="角色管理">
    <!-- 操作按钮区域 -->
    <div class="table-operator" style="margin: 5px 0 10px 2px" slot="extra">
            ...
            <a-form layout="inline" @keyup.enter.native="searchQuery">
              ...
              <a-col :md="11" :sm="12">
                <a-form-item label="创建时间" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                  <b-date v-model="queryParam.createTime_begin" :showTime="true" date-format="YYYY-MM-DD HH:mm:ss" style="width:45%" placeholder="请选择开始时间" ></b-date>
                  <span style="width: 10px;">~</span>
                  <b-date v-model="queryParam.createTime_end" :showTime="true" date-format="YYYY-MM-DD HH:mm:ss" style="width:45%" placeholder="请选择结束时间"></b-date>
                </a-form-item>
              </a-col>
              -->
