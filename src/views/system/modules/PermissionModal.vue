      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="授权策略">
            <b-dict-select-tag v-decorator="['permsType', {}]" placeholder="请选择授权策略" :type="'radio'" :triggerChange="true" dictCode="global_perms_type"/>
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="状态">
            <b-dict-select_tag v-decorator="['status', {}]" placeholder="请选择状态" :type="'radio'" :triggerChange="true" dictCode="valid_status"/>
...
import BDictSelectTag from '@/components/dict/BDictSelectTag.vue'
