<template>
  <a-card :bordered="false" title="系统日志">
    <!--导航区域-->
    <div>
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="5" :sm="8" v-if="tabKey === '2'">
            <a-form-item label="操作类型" style="left: 10px">
              <b-dict-select_tag v-model="queryParam.operateType" placeholder="请选择操作类型" dictCode="operate_type"/>
            </a-form-item>
          </a-col>
    ...
    <a-table
      ...
      <span slot="logContent" slot-scope="text, record">
          <b-ellipsis :value="text" :length="40"/>
        </span>
    </a-table>
    <!-- table区域-end -->
  </a-card>
