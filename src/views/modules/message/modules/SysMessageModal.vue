    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="发送方式">
          <b-dict-select_tag :triggerChange="true" dictCode="msgType" v-decorator="[ 'esType', {}]" placeholder="请选择发送方式">
          </b-dict-select_tag>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="发送状态">
          <b-dict-select_tag :triggerChange="true" dictCode="msgSendStatus" v-decorator="[ 'esSendStatus', {}]" placeholder="请选择发送状态">
          </b-dict-select_tag>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
