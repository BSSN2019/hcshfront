        ...
        <a-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }">
          ...
          <a-col :span="12">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="模板类型">
              <b-dict-select_tag  @change="handleChangeTemplateType" :triggerChange="true" dictCode="msgType" v-decorator="['templateType', validatorRules.templateType ]" placeholder="请选择模板类型">
              </b-dict-select_tag>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :span="24" pull="4">
            <a-form-item
              ...
              label="模板内容"
              style="margin-left: 4px;width: 126%">
              <b-editor  v-model="templateEditorContent"></b-editor>
            </a-form-item>
          </a-col>
        </a-row>
...
<script>
  ...
  import BEditor from '@/components/bssn/BEditor'
